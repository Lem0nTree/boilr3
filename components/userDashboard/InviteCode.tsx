...
export const InviteCode = ({ userData }: InviteCodeProps) => {
  ...
  const inviteLink = `${window.location.origin}?invite=${userData.invitationCode}`;

  // Define an array of tweet messages
  const tweetMessages = [
  ...
  // Function to share on Twitter with a random tweet message
